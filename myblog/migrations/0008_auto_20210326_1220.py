# Generated by Django 3.1.2 on 2021-03-26 07:50
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('myblog', '0007_remove_article_hits'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='article',
            name='hits',
            field=models.ManyToManyField(blank=True, related_name='hits', through='myblog.ArticleHit', to='myblog.IPAddress'),
        ),
    ]
